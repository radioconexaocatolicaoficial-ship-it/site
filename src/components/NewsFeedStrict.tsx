...
const CAMINHADA_HIGHLIGHT_DESCRIPTION =
  'Com o tema "A Fé que Transforma", a 19ª edição contará com missas, pregações, shows, adoração e confissões. Data: Domingo, 16 de agosto de 2026, das 08h às 21h. Local: Ginásio do Ibirapuera (R. Manuel da Nóbrega, 1361 - Ibirapuera, SP). Entrada gratuita com inscrição prévia (vagas limitadas) + 1kg de alimento não perecível. Retirada de camisetas: no dia do evento (7h) ou antecipadamente na Catedral Maronita (R. Tamandaré, 355, Liberdade) ou Loja Canção Nova (R. Domingos de Moraes, 348, perto metrô Ana Rosa). Fique atento às redes sociais para mais informações!';
            ...
            {!highlight ? (
              ...
              <div className="nfs-highlight__stack">
                <div className="nfs-highlight__link-wrapper">
                  ...
                  <p className="nfs-highlight__intro">
                    Com o tema "A Fé que Transforma", a 19ª edição contará com missas, pregações, shows, adoração e confissões. Entrada gratuita com inscrição prévia (vagas limitadas) + 1kg de alimento não perecível.
                  </p>
                  <div className="nfs-highlight__info-list">
                    <div className="nfs-highlight__info-item">
                      <span className="nfs-highlight__info-dot">●</span>
                      <span className="nfs-highlight__info-text"><strong>Data:</strong> Domingo, 16 de agosto de 2026</span>
                    </div>
                    <div className="nfs-highlight__info-item">
                      <span className="nfs-highlight__info-dot">●</span>
                    ...
                    <div className="nfs-highlight__info-item">
                      <span className="nfs-highlight__info-dot">●</span>
                      <span className="nfs-highlight__info-text"><strong>Retirada de Camisetas:</strong> No dia do evento (a partir das 7h) ou antecipadamente na Catedral Maronita (R. Tamandaré, 355, Liberdade) e Loja Canção Nova (R. Domingos de Moraes, 348, próximo metrô Ana Rosa)</span>
                    </div>
                  </div>
                  <a
                    href={highlight.link}
