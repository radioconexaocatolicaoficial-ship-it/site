...
const CountdownCard = () => {
  ...
  return (
    <div className="h-full rounded-xl overflow-hidden gradient-primary text-primary-foreground p-6 flex flex-col justify-between relative">
      ...
      <div className="relative z-10">
        ...
        <h2 className="text-2xl font-extrabold mt-1 leading-tight">CAMINHADA DA<br />RESSURREIÇÃO</h2>
      ...
      <div className="relative z-10 flex flex-col gap-2 mt-4">
        <a href="https://stream.zeno.fm/yn65fsaurfhvv" target="_blank" rel="noopener noreferrer"
