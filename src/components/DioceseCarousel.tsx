...
const FEED = "https://www.diocesesaomiguel.org.br/feed";

const fallback: RssItem[] = [
  { img: "https://wsrv.nl/?url=www.diocesesaomiguel.org.br/images/jubileu_5.jpg&w=600&h=338&fit=cover&a=attention&output=jpg", title: "Notícias da Diocese de São Miguel Paulista", desc: "Acompanhe as últimas notícias da Diocese.", link: "https://www.diocesesaomiguel.org.br/" },
  { img: "https://wsrv.nl/?url=www.diocesesaomiguel.org.br/images/cartaz_Caminhada.jpg&w=600&h=338&fit=cover&a=attention&output=jpg", title: "42ª Caminhada da Ressurreição", desc: "Evento pascal da Zona Leste de São Paulo.", link: "https://www.caminhadadaressurreicao.com/" },
];
